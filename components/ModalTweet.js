              ...
              <div className="flex px-4 pt-1 pb-2.5 sm:px-6">
                <div className="w-full">
                  {/* <div className="text-[#6e767d] flex gap-x-3 relative">
                   ...
                   {/* <p className='text-white/50 ml-14  text-sm '>En réponse à <span className='text-[#1d9bf0]'>@{post?.tag}</span> </p> */}
                  <div className="mt-1 flex space-x-3 w-full">
                    ...
                    <div className="flex-grow mt-2">
                      ...
                      <div className="flex items-center space-x-2 mb-3">
                        ...
                        <p className="text-[#1d9bf0] text-xs font-bold">Tout le monde peut répondre </p>
                      </div>
