    ...
    <div className="hidden ml-10 sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full">
      ...
      className="flex items-center justify-center w-14 h-14 hoverAnimation p-0 xl:ml-24">
        ...
        <SidebarLink text="Plus" Icon={DotsCircleHorizontalIcon} />
          ...
          className='hidden xl:inline ml-auto bg-[#1d9bf0] text-white rounded-full w-56 h-[52px] text-lg font-bold  shadow-cyan-300 hover:bg-[#1a8cd8]'>Tweeter</button>
          <button
           onClick={(e) => {
            setIsOpenTweet(true);
          }}
          className=' flex xl:hidden  bg-[#1d9bf0] text-white rounded-full w-12 h-12 font-bold  shadow-cyan-300 hover:bg-[#1a8cd8]'>
